...
use App\UI\Rest\DTO\SavedProductDTO;
...
class CreateProductAction
{
     ...
     */
    public function __invoke(CreateProductCommand $command): JsonResponse
    {
        try {
        ...
        return JsonResponse::fromJsonString(
            $this->serializer->serialize(SavedProductDTO::fromSavedProduct($product), JsonEncoder::FORMAT),
